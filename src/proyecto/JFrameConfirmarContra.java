...
public class JFrameConfirmarContra extends javax.swing.JFrame {
    
    int xMouse, yMouse;
    public JFrameConfirmarContra() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtConfirContra.setForeground(new java.awt.Color(153, 153, 153));
        txtConfirContra.setText("1234567890");
        txtConfirContra.setBorder(null);
        txtConfirContra.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        txtConfirContra.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                txtConfirContraMouseReleased(evt);
            }
        });
        ...
        JPanelBarra2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, JPanelBarra2Layout.createSequentialGroup()
                ...
                .addGroup(JPanelBarra2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(JPanelBarra2Layout.createSequentialGroup()
                        .addGroup(JPanelBarra2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtConfirContra, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(58, 58, 58))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, JPanelBarra2Layout.createSequentialGroup()
    ...
    private void txtConfirContraMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtConfirContraMouseReleased
        
        if(String.valueOf(txtConfirContra.getPassword()).equals("1234567890"))
        {
    ...
    }//GEN-LAST:event_txtConfirContraMouseReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConfirmarContra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameConfirmarContra().setVisible(true);
            }
        });
    }
