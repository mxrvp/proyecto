...
public class JFrameAviso3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Esta seguro que desea Salir?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameAviso3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameAviso3().setVisible(true);
            }
        });
    }
